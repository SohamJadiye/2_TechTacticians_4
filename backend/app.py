...
@app.route('/')
def index():
     return render_template('../frontend/templates/index.html', home_template='../frontend/templates/home.html')
...
def upload_file():
    ...
    if uploaded_file.filename != '':
        ...
        return render_template('../frontend/templates/result.html', summarized_text=summarized_text)
    else:
